...
public:
  ...
  std::string toString() const override {
    return std::format("MouseScrolledEvent: ({0}, {1})", getXOffset(),
                       getYOffset());
  }
...
public:
  ...
  std::string toString() const override {
    return std::format("MouseButtonPressedEvent: {0}", getMouseButton());
  }
...
public:
  ...
  std::string toString() const override {
    return std::format("MouseButtonReleasedEvent: {0}", getMouseButton());
  }
